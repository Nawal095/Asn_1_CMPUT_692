...
# ************************* #
#predicted_sql_path='predict_qwen_previous.json' # Replace with your predict sql json path
#predicted_sql_path='predict_qwen_rag.json' # Replace with your predict sql json path
#predicted_sql_path='predict_llama.json' # Replace with your predict sql json path
predicted_sql_path='predict_llama_previous.json' # Replace with your predict sql json path
